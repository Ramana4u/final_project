...
def lambda_handler(event, context):
     ...
     load_balancer = lb.create_load_balancer(
          ...
          Subnets=['subnet-0ad08acb398ada09d','subnet-0a22ca2d020ca46c1'],
          Type='network',
          IpAddressType='ipv4')
...
sudo git clone https://github.com/Ramana4u/final_project.git
...
sudo mysql -h {end_point} -u admin --password=ramana4u2021 zmsdb < /final_project/sourcecode/SQL\ File/zmsdb.sql
'''
     user_Data_bytes = user_Data.encode("ascii")
     base64_bytes = base64.b64encode(user_Data_bytes)
     base64_string = base64_bytes.decode("ascii")
